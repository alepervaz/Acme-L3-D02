...
<table class="table table-sm">
    <tr>
        ...
        <th scope="row">
            <acme:message code="administrator.dashboard.form.label.provider"/>
        </th>
        <td>
            <acme:print value="${principalsByRole['Provider']}"/>
        </td>
        <th scope="row">
        ...
        <th scope="row">
            <acme:message code="administrator.dashboard.form.label.consumer"/>
        </th>
        <td>
            <acme:print value="${principalsByRole['Consumer']}"/>
        </td>
        <th scope="row">
...
<c:forEach items="${currentsOffersStats.keySet()}" var="currency">
    ...
    <tr>
        ...
        <td>
            <acme:print value="${currencyData.min}"/>
        </td>
        <th scope="row">
            <acme:message code="administrator.dashboard.form.label.offer.max"/>
        </th>
        <td>
            <acme:print value="${currencyData.max}"/>
        </td>
        <th scope="row">
