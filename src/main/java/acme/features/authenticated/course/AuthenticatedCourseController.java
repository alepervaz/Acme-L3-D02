...
public class AuthenticatedCourseController extends AbstractController<Authenticated, Course> {
	...
	@Autowired
	protected AuthenticatedCourseListService	listCourseService;
	@Autowired
	protected AuthenticatedCourseShowService	showCourseService;
	...
	protected void initialise() {
		...
		super.addBasicCommand("show", this.showCourseService);
