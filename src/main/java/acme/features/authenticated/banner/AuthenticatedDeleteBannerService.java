...
@Service
public class AuthenticatedDeleteBannerService extends AbstractService<Authenticated, Banner> {
	...
	public void bind(final Banner object) {
		...
		super.bind(object, AuthenticatedDeleteBannerService.PROPERTIES);
	}
	...
	public void unbind(final Banner object) {
		...
		tuple = super.unbind(object, AuthenticatedDeleteBannerService.PROPERTIES);
